        ...
        return (
            <div className="bg-white shadow-lg rounded-b-md p-6 mb-6 relative">
                    ...
                    {isEditing ? (
                        ...
                        <div>
                                <p className="mb-2">
                                        <strong>Nom:</strong> {teacher.personalInfo.firstName} {teacher.personalInfo.lastName}
                                </p>
                                <p className="mb-2">
                                        <strong>Date de naissance:</strong> {new Date(teacher.personalInfo.dateOfBirth).toLocaleDateString()}
                                </p>
                                <p className="mb-2">
                                        <strong>Numéro de téléphone:</strong> {teacher.personalInfo.phoneNumber}
                                </p>
                                <p className="mb-2">
                                        <strong>Email:</strong> {teacher.personalInfo.email}
                                </p>
                                <p>
                                        <strong>Adresse:</strong> {teacher.personalInfo.address.city}, {teacher.personalInfo.address.state}, {teacher.personalInfo.address.zip}
                                </p>
                        </div>
                    )}
            </div>
