    ...
    <div className="mt-8">
      ...
      <div className="relative mt-5 overflow-x-auto shadow-md sm:rounded-lg">
        <table className="w-full text-left text-sm text-gray-700 rtl:text-right dark:text-gray-400">
          <caption className="bg-white p-5 text-left font-semibold text-gray-900 rtl:text-right dark:bg-gray-800 dark:text-white sm:text-sm md:text-2xl">
            Les Utilisateurs
          </caption>
          <button className="absolute top-3 right-3 flex items-center justify-center rounded-full bg-green-500 p-1 text-[10px] text-white hover:cursor-pointer sm:p-2 sm:text-xs md:p-3 md:text-[15px]">
              ...
              >
                ...
                <td className="group relative px-4 py-4 text-center">
                  ...
                  >
                    ...
                    <span className="absolute left-1/2 z-50 hidden -translate-x-1/2 -translate-y-12 transform rounded bg-gray-800 p-1 text-xs text-white group-hover:block">
                      Desactiver
                    </span>
                  </button>
                </td>
                <td className="group relative px-4 py-4 text-center">
                  ...
                  >
                    ...
                    <span className="absolute left-1/2 hidden -translate-x-1/2 -translate-y-12 transform rounded bg-gray-800 p-1 text-xs text-white group-hover:block">
                      Activer
                    </span>
                  </button>
                </td>
