...
const CheckTable = ({ tableName, columnsData, tableData, onAjouterClick, handleCheckboxChange, handleDeleteSelected, selectedFormations, handleDetailClick ,handleEmploi}) => {
